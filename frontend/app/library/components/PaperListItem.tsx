...
export default function PaperListItem({ paper, onClick, onContextMenu }: PaperListItemProps) {
  return (
    <div
      ...
      className="flex items-start gap-4 p-4 rounded-lg border border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors cursor-pointer"
    >
